...
import Controller.CurrentControllerDC;
import Controller.PowerControllerDC;
import Controller.VoltageControllerDC;
 ...
 */
public class JPanelPowerSupplyDC extends JPanel
{
    //Frame object.
     ...
     */
    JPanelPowerSupplyDC(FrameVoltageDrop objectFrame)
    {
        ...
        JLabel voltageJLabel=new JLabel("Voltage (DC):");
    ...
    //End of the constructor JPanelPowerSupplyDC().
    ...
    public void paintComponent(Graphics graphics)
    {
        ...
        File imageFile=new File("src/Images/PowerSupply.gif");
        ...
        graphics.drawImage(image, 40, 0, 250, 185, null);
    }
    ...
    private Boolean voltageAction(String initialVoltage, Double finalVoltage)
    {
        ...
        {
            VoltageControllerDC voltageControllerDC = new VoltageControllerDC(frame);
            voltageControllerDC.updateFrame();
    ...
    */
    private Boolean currentAction(String initialCurrent, Double finalCurrent)
    {
        ...
        {
            CurrentControllerDC currentControllerDC = new CurrentControllerDC(frame);
            currentControllerDC.updateFrame();
    ...
    private Boolean powerAction(String initialPower, Double finalPower)
    {
        ...
        {
            PowerControllerDC powerControllerDC = new PowerControllerDC(frame);
            powerControllerDC.updateFrame();
...
//End the JPanelPowerSupplyDC() class.
