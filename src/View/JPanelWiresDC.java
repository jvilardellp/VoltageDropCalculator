...
import Controller.WireControllerDC;
 ...
 */
public class JPanelWiresDC extends JPanel
{
    //Frame object.
     ...
     */
    JPanelWiresDC(FrameVoltageDrop objectFrame)
    {
        ...
        sectionJComboBox.addItemListener(itemEvent ->
                {
                    if(!init)
                    {
                        ...
                        WireControllerDC wireControllerDC =new WireControllerDC(frame);
                        wireControllerDC.updateFrame();
    ...
    //End of the constructor JPanelWiresDC().
...
//End of the class JPanelWiresDC() class.
