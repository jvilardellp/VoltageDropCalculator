 ...
 */
public class VoltageDropDataAC
{
    //Fields of the class.
    //1-Power supply.
    ...
    */
    ...
    /**
     * Getter method to get the Phi Cos.
     * @return : Return to double number with the Phi Cos.
     */
    public Double getPhiCos()
    {
        return phiCos;
    }
    ...
    /**
     * Setter to add the voltage drop value to this class.
     * @param phiCos : Double voltage drop value.
     */
    public void setPhiCos(Double phiCos)
    {
        this.phiCos=phiCos;
    }
    ...
    /**
     * Method to get the length of the wire. Formula -> L = Au x S / 2 x I x p x c.
    ...
    public Double calculateLength()
    {
        ...
        Double result=(voltageDrop*section)/(2*current*p*phiCos);
