 ...
 */
public class PowerControllerAC
{
     ...
     */
    public PowerControllerAC(FrameVoltageDrop objectFrame)
    {
    ...
    public void updateFrame()
    {
        ...
        frame.getJPanelPowerSupplyAC().setPower(String.valueOf(data.getPower())); //Power.
