...
/**
 * Controller class to re-calculate the data of the frame when the drop voltage value is changed.
 * @author : Jaume V.
 * @version : 18/07/2016/A
 */
public class VoltageDropControllerDC
{
    ...
    /**
     * Constructor to initiating the drop voltage controller.
     * @param objectFrame : Frame object. Frame of the application.
     */
    public VoltageDropControllerDC(FrameVoltageDrop objectFrame)
    {
    ...
    //End of the constructor VoltageDropController().

    /**
     * Class to update the fields that depends of the new value of the drop voltage.
     */
